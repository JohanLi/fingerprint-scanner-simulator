...
const fingerprintElements = {} as { [key in FingerprintI]: { [key in FingerprintElementI]: string } };
...
export const getFingerprintElement = (i: FingerprintI, j: FingerprintElementI) => fingerprintElements[i][j];
