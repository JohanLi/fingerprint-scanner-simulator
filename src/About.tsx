  ...
  return (
    <div className="-mt-12">
      ...
      <p className={pClass}>
        ...
        developer, and have worked in the gaming industry for Paradox
        Interactive. If you’re also into software development and tech in
        general, I hope you find{' '}
        <a href="https://johan.li" className={aClass}>
          my articles
        </a>{' '}
        interesting!
      </p>
      <p className={pClass}>
        ...
        . I’ve done the Casino Heist many times – if you’d be interested in me
        creating a guide with tips and tricks on how to do both the heist and
        set ups quickly, let me know.
      </p>
    </div>
  );
}
